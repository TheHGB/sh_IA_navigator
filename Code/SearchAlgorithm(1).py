...
def setCostTable( typePreference, stationList,city):#En ello
    ...
    if typePreference == 1:#Temps
        for station in stationList:
            ...
            #for adjacent in city.adjacency[station].keys():
            #    if adjacent.id not in city.adjacency[station.id]:#El cost nomes de les adjacents
            #    temp_dic[station.id] = 0
