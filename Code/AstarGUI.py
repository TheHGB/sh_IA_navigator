...
class _Astargui:
    ...
    def __init__(self, master):
        ...
        #self.filenameMetro.set(os.path.join(os.path.dirname(__file__),"..","CityInformation","Lyon_smallCity","Stations.txt"))
        #prefix = os.path.join(os.path.dirname(__file__),"..","CityInformation","Lyon_smallCity")
        prefix = os.path.join(os.path.dirname(__file__),"..","CityInformation","Lyon_bigCity")
        self.filenameMetro.set(os.path.join(prefix,"Stations.txt"))
        self.filenameConnections.set(os.path.join(prefix,"Connections.txt"))
        self.filenameTimeStations.set(os.path.join(prefix,"Time.txt"))
        self.filenameInfoTransfers.set(os.path.join(prefix,"InfoTransfers.txt"))
        self.filenameInfoVelocity.set(os.path.join(prefix,"InfoVelocity.txt"))
        self.filenameInfoTransfers.set(os.path.join(prefix,"InfoTransfers.txt"))
